...
public class newGuardAdapter extends ArrayAdapter<Result> {


    public newGuardAdapter(@NonNull Context context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (currentNews != null) {
            ...
            String apiTime = currentNews.getWebPublicationDate();
            String date = "no date";
            String time = "";
            ...
            headlineTextView.setText(currentNews.getWebTitle());
